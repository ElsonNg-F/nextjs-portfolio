      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          ...
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons text-black dark:text-white">myportfolio</h1>
            <ul className="flex items-center">
              <li><BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className="cursor-pointer text-2xl fill-black dark:fill-gray-200" /></li>
          ...
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-300">
              ...
              and collaborated with talented people to create digital products for both businesses and consumers.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-300">
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 bg-gray-100 dark:bg-gray-800">
              ...
              <p className="text-gray-800 py-1 dark:text-gray-4300">Figma</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 bg-gray-100 dark:bg-gray-800">
        ...
        <section>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1"><Image src={web1} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
            <div className="basis-1/3 flex-1"><Image src={web2} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
            <div className="basis-1/3 flex-1"><Image src={web3} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
            <div className="basis-1/3 flex-1"><Image src={web4} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
            <div className="basis-1/3 flex-1"><Image src={web5} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
            <div className="basis-1/3 flex-1"><Image src={web6} className="rounded-lg object-cover" width={'100%'} height={'100%'} responsive alt="" /></div>
          </div>
        </section>
